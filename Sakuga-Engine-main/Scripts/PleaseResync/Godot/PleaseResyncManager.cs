...
namespace PleaseResync
{
	public partial class PleaseResyncManager : Node
	{
		...
		public override void _Ready()
		{
			...
			RollbackInfo = GetTree().Root.GetNode<Label>("Root/CanvasLayer/GameHUD_Background/ConnectionStatus/RollbackInfo");
			PingInfo = GetTree().Root.GetNode<Label>("Root/CanvasLayer/GameHUD_Background/ConnectionStatus/PingInfo");
